...
import {
	...
	BITRATE_QHD,
	CHROME_MEDIA_SOURCE,
	createEmptyRecordingSessionFacts,
	DEFAULT_HEIGHT,
	DEFAULT_WIDTH,
	FOUR_K_PIXELS,
...
export function resetRecordingSessionFacts(refs: ScreenRecorderRefs) {
	refs.recordingSessionFacts.current = createEmptyRecordingSessionFacts();
}

export function updateRecordingSessionFacts(
	refs: ScreenRecorderRefs,
	patch: Partial<RecordingSessionFacts>,
) {
	refs.recordingSessionFacts.current = {
		...refs.recordingSessionFacts.current,
		...patch,
	};
}
