...
export const SOURCE_AUDIO_MUX_TOAST_ID = "recording-audio-mux-warning";
export const MICROPHONE_FALLBACK_TOAST_ID = "recording-microphone-fallback";
export const MICROPHONE_FALLBACK_ERROR_TOAST_ID = "recording-microphone-fallback-error";
export const MICROPHONE_SIDECAR_ERROR_TOAST_ID = "recording-microphone-sidecar-error";

export const LINUX_PORTAL_SOURCE: ProcessedDesktopSource = {
...
export type RecordingSessionFacts = {
...
export function createEmptyRecordingSessionFacts(): RecordingSessionFacts {
	return {
		captureBackend: null,
...
export type ScreenRecorderRefs = {
	...
	recordingSessionFacts: MutableRefObject<RecordingSessionFacts>;
};
