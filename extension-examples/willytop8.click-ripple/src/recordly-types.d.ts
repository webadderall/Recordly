/**
 * Recordly Extension API types — copied verbatim from
 * Recordly/src/lib/extensions/types.ts for standalone extension use.
 * Do not modify; regenerate from source when the API changes.
 */
